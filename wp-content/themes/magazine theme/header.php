...
<title><?php wp_title(); ?>MAGAZINE</title>
	...
	<div class="container-fluid">
		<div class="container">
			<div class="row">
				...
				<img src="<?php echo get_template_directory_uri(); ?>/assets/images/logo.png" alt="img" class="fh5co_logo_width"/>
				</div>
	...
	<div class="container-fluid bg-faded fh5co_padd_mediya padding_786">
		<div class="container padding_786">
			<nav class="navbar navbar-toggleable-md navbar-light ">
				...
				<a class="navbar-brand" href="#"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/white_logo.png" alt="img" class="mobile_logo_width"/></a>
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
         <?php
              wp_nav_menu(
                array(
                  'theme_location' => 'magazine_menu',
                  'menu' => 'magazine_menu',
                  'container' => 'ul',
